...
<script>
// import JqueryFloat from '../../assets/js/plugins/flot/jquery.flot.js'
// import Tooltip from '../../assets/js/plugins/flot/jquery.flot.tooltip.min.js'
// import Spline from '../../assets/js/plugins/flot/jquery.flot.spline.js'
// import Resize from '../../assets/js/plugins/flot/jquery.flot.resize.js'
// import FlotPie from '../../assets/js/plugins/flot/jquery.flot.pie.js'
// import Peity from '../../assets/js/plugins/peity/jquery.peity.min.js'
// import PeityDemo from '../../assets/js/demo/peity-demo.min.js'
import Jvectormap from '../../assets/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js'
import JvectormapWorld from '../../assets/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js'
//import Content from '../../assets/js/content.min.js?v=1.0.0'
//import JqueryGritter from '../../assets/js/plugins/jquery-ui/jquery-ui.min.js'
// import Easypiechart  from '../../assets/js/plugins/easypiechart/jquery.easypiechart.js'
// import Sparkline from '../../assets/js/plugins/sparkline/jquery.sparkline.min.js'
// import SparklineDemo from '../../assets/js/demo/sparkline-demo.min.js'
// import JqueryGritter from '../../assets/js/plugins/gritter/jquery.gritter.min.js'
