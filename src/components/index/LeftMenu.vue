    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li v-for="(menuItem,index1) in menuList" >
                    <router-link :to="menuItem.path" class="J_menuItem" id="menuItem.id" v-if="!menuItem.isParent" @click.native="changeRouter(menuItem)">
                        <i :class=menuItem.icon v-if="menuItem.icon"></i>
                        <span class="nav-label">{{menuItem.text}}</span>
                    </router-link>
                    <a href="#" v-if="menuItem.isParent" @click="changeMenu">
                        <i :class=menuItem.icon v-if="menuItem.icon"></i>
                        <span class="nav-label">{{menuItem.text}}</span>
                        <span class="fa arrow"></span>
                    </a>
                   
                        <ul class="nav nav-second-level collapse"  v-if="menuItem.isParent">
                            <li  v-for="(menu2,index2) in menuItem.children">
                                <router-link :to="menu2.path" @click.native="changeRouter(menu2)" class="J_menuItem" id="menu2.id" v-if="!menu2.isParent">
                                    <i :class=menu2.icon v-if="menu2.icon"></i>
                                    <span class="nav-label">{{menu2.text}}</span>
                                </router-link>
                                <a href="#" v-if="menu2.isParent" @click="changeMenu">
                                    <span class="nav-label">{{menu2.text}}</span>
                                    <span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level collapse" v-if='menu2.isParent'>
                                    <li><a class="J_menuItem" href="mailbox.html">1231</a>
                                    </li>
                                    <li><a class="J_menuItem" href="mail_detail.html">123123</a>
                                    </li>
                                    <li><a class="J_menuItem" href="mail_compose.html">42141</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
...
export default {
    data() {
        ...
        methods: {
            changeMenu(e) {
                $(e.target).parent("li").toggleClass("active").children("ul").collapse("toggle");
            ...
            changeRouter(menu){
                ...
                this.$store.dispatch("addMenuTab",menutab);
            }
        },
        computed: mapState({
...
<!-- 保留菜单 -->
<!-- 
 <ul class="nav nav-third-level" v-for="(menu3,index) in menu2.children">
                                <li>
                                    <router-link :to="menu3.path" class="J_menuItem" id="menu3.id" v-if="!menu2.isParent">
                                        <i :class=menu3.icon v-if="menu3.icon"></i>
                                        <span class="nav-label">{{menu3.text}}</span>
                                    </router-link>
                                </li>
                            </ul>
 -->
